...
wall.addEventListener("click", (e)=>{
    const targetTop = clamp(e.clientY - spiderHeight / 2 - wallBorderWidth - wall.getBoundingClientRect().top, 0, wallHeight - spiderHeight);
    const targetLeft = clamp(e.clientX - spiderWidth / 2 - wallBorderWidth - wall.getBoundingClientRect().left, 0, wallWidth - spiderWidth);
